import "./About.css"; // Currently no CSS on this, all Bootstrap

// Can add relevant info and image files later
          ...
          <div class="row justify-content-center text-center mb-2 mb-lg-4">
            <div class="col-12 col-lg-8 col-xxl-7 text-center mx-auto">
              ...
              <p class="lead">
                ...
                harum ipsum venenatis metus sem veniam eveniet aperiam suscipit.
              </p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card text-center border-0 mb-3">
                <div class="card-body p-3">
                  ...
                  <div class="text-muted mb-3">Programmer</div>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Soluta harum ipsum venenatis metus.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="row g-4 g-md-5">
                <div class="col-lg-6">
                  <div class="d-flex">
                    ...
                    <div>
                      <h5 class="mb-2 mb-lg-4 fw-bold">
                        Lorem ipsum dolor adipisicing ?
                      </h5>
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Veritatis, nihil. Praesentium nostrum fugiat id dolor.
                      </p>
                    </div>
                  </div>
                </div>
